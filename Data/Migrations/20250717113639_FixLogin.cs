    ...
    public partial class FixLogin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceSubmissions_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceSubmissionValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceSubmissionValues_ServiceFields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "ServiceFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceSubmissionValues_ServiceSubmissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "ServiceSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ServiceFields_ServiceId_Name",
                table: "ServiceFields",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSubmissions_ServiceId",
                table: "ServiceSubmissions",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSubmissionValues_FieldId",
                table: "ServiceSubmissionValues",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSubmissionValues_SubmissionId_FieldId",
                table: "ServiceSubmissionValues",
